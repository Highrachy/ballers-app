...
const Content = () => (
  <section>
    <div className="container my-md-5 my-3 py-5 terms-of-use">
      ...
      <h5 className="mt-6">Acknowledgement</h5>
      <p>
      ...
      <h5 className="mt-6">Links to Other Websites</h5>
      <p>
      ...
      <h5 className="mt-6">Governing Law</h5>
      <p>
      ...
      <h5 className="mt-6">Disputes Resolution</h5>
      <p>
      ...
      <h5 className="mt-6">For European Union (EU) Users</h5>
      <p>
        If You are a European Union consumer, you will benefit from any
        mandatory provisions of the law of the country in which you are resident
        in.
      </p>
      <h5 className="mt-6">United States Legal Compliance</h5>
      <p>
      ...
      <h5 className="mt-6">Severability and Waiver</h5>
      <h6 className="header-secondary">Severability</h6>
      <p>
      ...
      <h6 className="header-secondary">Waiver</h6>
      <p>
      ...
      <h5 className="mt-6">Translation Interpretation</h5>
      <p>
      ...
      <h5 className="mt-6">Changes to These Terms and Conditions</h5>
      <p>
