  ...
  <section>
    <div className="container my-md-5 my-3 py-5 terms-of-use">
      ...
      <p>
        ...
        Agreement and continued access to the BALL website shall constitute
      ...
      <p>
        ...
        content in the form of advertisements from private sellers, subscribing
        estate agents, letting agents, developers as well as related parties, to
      ...
      <ol type="a">
        ...
        <li>
          Violating any intellectual property rights belonging to BALLERS or any
          third party;
        </li>
      </ol>
      ...
      <p>
        ...
        databases and agreements, is the intellectual property of BALLERS.ng and
        is protected by local and international law dealing with copyright and
        intellectual property rights.
      </p>
      <p>
        BALLERS Team retains the authority to review all content posted by the
        Users on this Website and we reserve the right to terminate your use of
        the Service for violating any of the prohibited uses. You acknowledge
      ...
      <ul>
        ...
        <li>To obtain your feedback about Ballers’ site and Services,</li>
        <li>
      ...
      <ul>
        ...
        <li>
          You agree that BALLERS and its affiliates shall not be liable for any
          direct, indirect, punitive and all consequential damages or any
      ...
      <ul>
        <li>
          ...
          access to this Website and the related Service or any part thereof at
      ...
      <p>
        ...
        not, circumvent this agreement to directly or indirectly contact, deal
        with or otherwise become involved with any buyer entity or any other
        entities or parties introduced, directly or indirectly, by or through
        the BALL platform, its officers, directors, agents or associates, for
        the purpose of avoiding the payment to BALL, fees or otherwise, without
