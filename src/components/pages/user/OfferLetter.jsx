...
const CreateOfferLetter = () => {
  ...
  return (
    <BackendPage>
      <OfferLetterTemplate value={defaultValue} ref={componentRef} />
      <ReactToPrint
        trigger={() => (
...
class OfferLetterTemplate extends React.Component {
  render() {
    ...
    return (
      <div className="container-fluid">
        ...
        <Card className="mt-4 p-5">
          ...
          <strong>
            RE: BLISSVILLE, LEKKI LAGOS - LETTER OF OFFER FOR 3 BEDROOM
            APARTMENT
          </strong>

          <p className="">
            We refer to your application to purchase a unit in Blissville
            residential estate on Elder Nwuba Street, Off Dreamworld Africana
            Way, KM 20 Lekki – Epe expressway, Lekki, Lagoss and are pleased to
            offer you a 3 BEDROOM APARTMENT on the following terms and
            conditions:
          </p>
            ...
            <table className="table table-md table-borderless">
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    1 Unit of a 3 bedroom Apartment in a “condominium style”
                    with adjoining room situate on Elder Nwuba Street, off
                    Dreamworld Africana way, KM 20, Lekki /Epe expressway,
                    Lekki, Lagos.
                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td>
                    Due after the {value.allocation}% of payment received.
                  </td>
                </tr>
              </tbody>
            </table>
          ...
          <ol type="a">
            <li>
              <p>
                ...
                within 21 days after the due date, the Buyer shall pay interest
                on the amount due at the prevailing bank interest rate. If the
                Buyer fails to pay the amount due (plus applicable interest)
                within 45 days after the due date, the sale shall be deemed
                rescinded and the deposit already made shall be refunded to the
                Buyer. An administrative charge of 5% will be deducted from the
                amount received from the buyer and the balance will be refunded
                in line with the terms and conditions. The Buyer shall execute
                or facilitate the execution of the Deed of Assignment of the
                property ONLY upon full payment of the consideration.
              </p>
            </li>
            <li>
              <p>
                Where the subject unit is not completed within the said seven
                (7) months’ time frame, due to the negligence or fault of the
                Vendor, a grace period of two (2) months will be granted to
                complete all works after which the Vendor shall pay to the
                Buyer, an amount to be determined by 50% of the average annual
                rental value of similar types of units within the area for the
                unit, this is subject to the Buyer meeting up the monthly
                payment as at when due and completing payment within six (6)
                Months. The determined amount shall be paid by the Vendor at a
                pro-rated monthly rate for each month of delay after the agreed
                seven (7) months plus the grace period and shall become due and
                payable within the first ten (10) working days of the month.
              </p>
            </li>
            <li>
              <p>
                The Vendor shall ensure the execution of a Deed of Assignment
                for the subject unit of Blissville on the land covered by
                Governors consented Deed of Assignment dated the 20th day of
                May, 2016 and registered as No. 87 on page 87 in volume 2547v at
                the office of the Lagos State Land Registry, Ikeja, in favour of
                the Buyer.
              </p>
            </li>
            <li>
            ...
            <li>
              <p>
                ...
                imposed on the property by the Local, State or Federal
                Government of Nigeria and any increment thereto. The Buyer shall
                also pay and discharge any service charge including electricity
                bill and any other charges set out in the Deed of Assignment
                and/or service management agreement and any increment thereto.
              </p>
            </li>
            <li>
              <p>
                The Buyer shall enter into a service Management Agreement with
                the Vendor’s nominated Facility Managers on agreed terms and
            ...
            <li>
              <p>
                ...
                part thereof, the property shall first be offered to another
                buyer and the refund shall be made from the purchase price
                received from the subsequent buyer less administrative fees in
                line with terms and conditions captured herein.
              </p>
            </li>
          </ol>
...
const SignaturePad = () => {
  ...
  return (
    <>
      ...
      {input && <h3 className="signature-pad"> {input} </h3>}
      <button
